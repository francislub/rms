...
class RequisitionPhase1Form(forms.ModelForm):
    ...
    class Meta:
        model = Requisition
        fields = ['amount', 'reason', 'department', 'requester_name', 'requester_signature', 'request_date']  # Include request date field
...
class RequisitionPhase2Form(forms.ModelForm):
    ...
    class Meta:
        model = Requisition
        fields = ['supervisor_name', 'supervisor_signature', 'supervisor_comment', 'supervisor_date']  # Include supervisor date field
...
class RequisitionPhase3Form(forms.ModelForm):
    ...
    class Meta:
        model = Requisition
        fields = ['approver_name', 'approver_signature', 'charge_to_account', 'approver_date']  # Include approver date field
